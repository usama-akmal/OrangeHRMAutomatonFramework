...
namespace OrangeHRMAutomatonFramework.POM.EmployeeManagment
{
    public class EmployeeManagementLocators
    {
        ...
        public static string popupLocationItemsInDropdown = "#bs-select-12 > ul > li > a > span";
        ...
        public static string wizardJobTitleItemsInDropdown = "#bs-select-31 > ul > li > a > span";
        public static string wizardEmployementStatusDropdown = "[data-id='employment_status_id']";
        public static string wizardEmployementStatusItemsInDropdown = "#bs-select-41 > ul > li > a > span";
        public static string wizardJobCategoryDropdown = "[data-id='job_category_id']";
        public static string wizardJobCategoryItemsInDropdown = "#bs-select-42 > ul > li > a > span";
        public static string wizardSubUnitDropdown = "[data-id='subunit_id']";
        public static string wizardSubUnitItemsInDropdown = "#bs-select-43 > ul > li > a > span";
        ...
        public static string wizardFTEItemsInDropdown = "#bs-select-47 > ul > li > a > span";
        public static string wizardTempDepartmentDropdown = "[data-id='11']";
        public static string wizardTempDepartmentItemsInDropdown = "#bs-select-48 > ul > li > a > span";
